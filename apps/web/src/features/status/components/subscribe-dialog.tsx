  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md">
        ...
        {/* Channel Selection */}
        <div className="mt-2 grid grid-cols-3 gap-1 rounded-lg border border-border/50 bg-muted/30 p-1 text-xs font-medium">
          {(["email"] as const).map((ch) => {
            ...
            return (
              <button
                ...
                className={`flex items-center justify-center gap-1.5 rounded-md py-1.5 capitalize transition-all ${
                  active
